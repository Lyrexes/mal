...
Types::MalType EVAL(Types::MalType ast, const Env& env);
std::string PRINT(const Types::MalType& result, bool readably);
std::string REP(std::string arg, const char* regex, bool readably, const Env& env);
MalType eval_ast(const Types::MalType& t, const Env& env);
